...
// Cache: Standard (46 files: 37 guides + 6 tools + infra) — v1.0 · 2026-06-30
// Generated by patch_playbooks.py for Standard build — do not manually edit

const CACHE_NAME = 'scratch-project-standard-v1-1'; // Standard-only cache — 49 files (37 guides + 6 tools + infra + privacy/terms/404)

const STATIC_FILES = [
  // Standard tier: 37 guides + 6 tools + infrastructure = 46 files
  '/01_putting_pro.html',
