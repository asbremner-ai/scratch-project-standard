...
// Cache: Standard (105 files) — v1.8 · 2026-08-21
// Generated by patch_playbooks.py for Standard build — do not manually edit

const CACHE_NAME = 'scratch-project-standard-v1-8'; // Standard-only cache — 105 files
// v1.8 — chapter expansions C1-C9: nine guide files gained sourced evidence-update
// sections (field-strength SG, speed-training predictors, coach/S&C interface, CGM
// scepticism, wearable accuracy, warm-up evidence, age-related speed decline,
// consumer launch monitors, Rule vs Local Rule vs Committee). No guide added or
// retired. The version bump is what actually delivers the corrections to returning
// visitors; without it they keep the stale cached copies.
...
const STATIC_FILES = [
  ...
  '/fonts/dm-mono-latin-300-normal.woff2',
  ...
  '/fonts/playfair-display-latin-700-italic.woff2',
